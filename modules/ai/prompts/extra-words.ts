...
const template = `Summarize and extract the important nouns and verbs from the text. You response JSON array, dont explain, for example ["hello", "world"]. The text is. The text is: '''{text}'''`;
